...
// two-ink language as the heart. Each painter is deterministic (seeded) and
// pure: draw(ctx, state) with intro / hover / ht / look driving the motion.
// plates.js animates them on the page; the Instagram kit and reel reuse them.
...
export const PAINTERS = { inkblot: () => inkblot(9), schematic: () => schematic(26), iris: () => iris(3), maze: () => maze(1026), fingerprint: () => fingerprint(71), aperture };
